...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <form ref={form} onSubmit={sendEmail} className="w-full px-6 max-w-md">
        <div className="md:flex md:items-center mb-6">
          ...
          <div className="md:w-2/3">
            <input
              className=" appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-black-700 leading-tight focus:outline-none focus:bg-white"
              id="inline-full-name"
              type="text"
              placeholder="Name"
              name="user_name"
